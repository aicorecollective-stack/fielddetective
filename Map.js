...
export const MAP_LAYERS = [
  ...
  },
  {
    k: "historical",
    emoji: "📜",
    label: { el: "Ιστορικός", en: "Historical" },
    url: "https://tile.openhistoricalmap.org/main/{z}/{x}/{y}.png",
  ...
  },
  {
    k: "mapire",
    emoji: "🏛️",
    label: { el: "Mapire 1800s", en: "Mapire 1800s" },
    url: "https://maps.arcanum.com/en/map/europe-19century-secondsurvey/{z}/{x}/{y}.png",
    attribution: "© Mapire / Arcanum",
    maxZoom: 15,
  },
  {
    k: "ktimanet",
    emoji: "📸",
    label: { el: "Αεροφ. '60", en: "Aerial '60s" },
    url: "https://gis.ktimanet.gr/wms/ktbasemap/default/GoogleMapsCompatible/{z}/{y}/{x}.png",
