...
export default function App() {
  ...
  return (
    <div style={{background:'#020617',minHeight:'100vh',maxWidth:'430px',margin:'0 auto',display:'flex',flexDirection:'column',position:'relative'}}>
      ...
      {/* Area picking cancel button */}
      {pickingArea && (
        <button onClick={()=>setPickingArea(false)}
          style={{position:'fixed',bottom:'90px',left:'50%',transform:'translateX(-50%)',zIndex:9998,background:'#ef4444',border:'none',color:'white',padding:'12px 24px',borderRadius:'20px',fontWeight:'700',fontSize:'14px',cursor:'pointer',boxShadow:'0 4px 16px rgba(239,68,68,0.4)'}}>
